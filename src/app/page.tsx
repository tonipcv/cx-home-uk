...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-white text-black font-satoshi tracking-[-0.02em]">
      ...
      {/* Content Section */}
      <main className="py-16 px-4 sm:px-6 bg-white" role="main">
      ...
      {/* CTA Section */}
      <section className="py-20 px-4 sm:px-6 bg-blue-50" role="complementary">
        <div className="container mx-auto max-w-2xl">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <p className="text-gray-600 max-w-xl mx-auto">
              Discover how we can elevate your clinic's patient experience and operational efficiency through 
              intelligent automation and personalized care journeys.
            </p>
            <div className="pt-2">
              <Button 
                onClick={() => window.location.href = 'https://www.cxlus.com/demo'}
      ...
      {/* Footer */}
      <footer className="py-8 px-4 sm:px-6 border-t border-gray-100 bg-white" role="contentinfo">
        <div className="container mx-auto max-w-2xl">
